...
pacman -S sudo make gcc geany xterm ntfs-3g eog awesome tar uget leafpad wget xarchiver bcloud filezilla chromium firefox firefox-i18n-zh-cn firefox-adblock-plus flashplugin epdfview tigervnc yaourt wps-office
